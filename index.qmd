...
The result? **Random forests with 500+ trees achieve $39,000 test RMSE** — outperforming even the best single decision tree by $4,000 per prediction while maintaining perfect training-test alignment.

### 3. Linear Regression vs Random Forest Comparison

```{python}
#| label: linear-comparison-viz-python
#| echo: false
#| fig-width: 12
#| fig-height: 6
...
models = ['Linear Regression', '1 Tree', '100 Trees', '1000 Trees']
rmse_values = [lm_rmse, rmse_1_test, rmse_100_test, rmse_1000_test]
r2_values = [lm_r2, r2_1, r2_100, r2_1000]

# Colors for the bars
colors = ['#E63946', '#2E86AB', '#06A77D', '#06A77D']

# RMSE Comparison Plot
bars1 = ax1.bar(models, rmse_values, color=colors, alpha=0.8, edgecolor='black', linewidth=1.5)
ax1.set_ylabel('RMSE ($)', fontsize=12, fontweight='bold')
ax1.set_title('Model Performance: RMSE Comparison', fontsize=14, fontweight='bold', pad=15)
ax1.grid(axis='y', alpha=0.3, linestyle='--')
ax1.set_ylim(35000, 55000)
...
ax2.set_title('Model Performance: R² Comparison', fontsize=14, fontweight='bold', pad=15)
...
Before embracing the complexity of random forests, we should ask: **does the added sophistication justify the cost?** Linear regression is our baseline — it's interpretable, fast, and beloved by business stakeholders who want to understand exactly how features drive predictions.
...
1. **Single trees don't justify complexity:** A 1-tree random forest performs worse than linear regression. If you're only building one tree, stick with linear regression — you get similar or better performance plus interpretability.
...
3. **Diminishing returns beyond 1,000 trees:** Growing from 100 to 1,000 trees adds minimal incremental value — perhaps another 1-2% improvement. Unless computational resources are free and you're in a high-stakes domain, 100-500 trees is the pragmatic choice.
